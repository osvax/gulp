...
const EMAIL_SETTINGS = [
  'addresses' => ['osvax@yandex.com'], // кому необходимо отправить письмо
  'from' => ['test@valexo.ru', 'Заявка с вашего сайта'], // от какого email и имени необходимо отправить письмо
  'subject' => 'Сообщение с формы обратной связи', // тема письма
  'host' => 'ssl://smtp.timeweb.ru', // SMTP-хост
  'username' => 'test@valexo.ru', // // SMTP-пользователь
  'password' => 'DerbiTgm9XX', // SMTP-пароль
  'port' => '465' // SMTP-порт
];
